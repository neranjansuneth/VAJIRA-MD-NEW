...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=6F9HUDYL#4as7rnPNh3F8QEFPjL_asKVypWcPHi-sizVgle4u9jE' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '04753122502' : process.env.OWNER_NUMBER,   
